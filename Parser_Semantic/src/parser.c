...
void compileForSt(void) {
    ...
    eat(SB_ASSIGN);
    type1 = compileMultiAssignSt();
    checkTypeEquality(var->varAttrs->type, type1);

    eat(KW_TO);
    type2 = compileMultiAssignSt();
...
void compileArgument(Object *param) {
    ...
    checkTypeEquality(compileMultiAssignSt(), param->paramAttrs->type);
}
...
Type *compileMultiAssignSt(void) {
    Type *type;
